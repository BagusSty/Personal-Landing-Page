...
const Carousel = () => {
  ...
  const slideImages = [
    {
      ...
      icon2: {
        icon: <BiLogoTailwindCss className="h-6 w-6" />,
        name: "Tailwind CSS",
      },
    },
    {
  ...
  return (
    <div className="swiper-container w-[80%]">
      <Swiper
        effect={"coverflow"}
        grabCursor={true}
        centeredSlides={true}
        ...
        className="mySwiper p-24 h-fit object-cover"
      >
          ...
          <SwiperSlide key={index}>
            <a href={slide.link} target="_blank">
              <div className="relative">
                ...
                <div
                  className={`absolute bottom-0 left-0 w-full h-full p-12 flex items-end ${
                    darkMode
                  ...
                  >
                    <div className="flex justify-center items-center space-x-6">
                      <div className="flex flex-col items-center">
                        {slide.icon1.icon}
                        <p>{slide.icon1.name}</p>
                      </div>
                      <div className="flex flex-col items-center">
                        {slide.icon2.icon}
                        <p>{slide.icon2.name}</p>
                      </div>
                    </div>
                  </div>
                </div>
